...
public class KkuSystem implements OptionalReserveTasks, FileNames, ReserveTasks {
	...
	public void showCLIMenu() {
		...
		while(true) {
			...
			System.out.println("10-To search a ReservedBlocks Py Person");
			...
			case "1":
				...
				st=this.reserveBlock(new ReserveBlock(p,o.getL(),time.getT(),r));
					...
					System.out.println("Pless ageen letar");
				}
				break;				
			case "2":
	...
	public boolean loadDataFromFile() {
		...
		ObjectInputStream o;
			try {
				...
				System.out.println("File Not Found to load >_<");
			} catch (IOException e) {
				System.out.println("Could not load from file >_<");
				e.printStackTrace();
			} catch(Exception e) {
				System.out.println("Unknow error in load file >_<");
				e.printStackTrace();
			}
		return false;
	}
	...
	public boolean saveDataToFile() {
		...
		{
			System.out.println("Nothing to save >_<");
			return true;
		}
		else {
	...
	public boolean exportToFile2() {
		if(KkuSystem.reservations.isEmpty())
		{
			System.out.println("Nothing to export >_<");
			return true;
		}
		else {
			try {
				...
				String timeStamp = new SimpleDateFormat("yyyy-MM-dd | HH:mm:ss").format(Calendar.getInstance().getTime());
				o.println("\n|-_-_-_-_-_-_-_-|"+timeStamp+"|-_-_-_-_-_-_-_-_|");
